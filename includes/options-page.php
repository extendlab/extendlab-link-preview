...
function extlbOptionsPage() {
	...
	<div class="wrap">
		<h1><?php _e('Extendlab - Link Preview Settings', 'extlb_link-preview') ?></h1>
		<form method="post" action="options.php">
			...
			<table class="form-table">
				<tbody>
					<tr>
						<th scope="row"><?php _e('Appearance', 'extlb_link-preview') ?></th>
						<td>
							<fieldset>
								<label for="extlb_darkmode">
										...
										<?php _e('Darkmode on', 'extlb_link-preview') ?>
								</label>
								<p class="description"><?php _e('You can choose if you want a dark grey or a white popup', 'extlb_link-preview') ?></p>
							</fieldset>
						</td>
					</tr>
					<tr>
						...
						<td>
							<fieldset>
								<label for="extlb_hide_thumbnails">
										...
										<?php _e('Hide Thumbnails', 'extlb_link-preview') ?>
								</label>
								<p class="description"><?php _e('You can toggle the visibility of the article thumbnails inside the popup', 'extlb_link-preview') ?></p>
							</fieldset>
						</td>
					</tr>
					<tr>
						<th scope="row"><?php _e('Visibility', 'extlb_link-preview') ?></th>
						<td>
							<fieldset>
								<label for="extlb_disable_mobile">
										...
										<?php _e('Hide on mobile (< 720px)', 'extlb_link-preview') ?>
								</label>
								<p class="description"><?php _e('You can choose if you want to deactivate the popup on mobile devices', 'extlb_link-preview') ?></p>
							</fieldset>
						</td>
					</tr>

					<tr>
						<th scope="row"><?php _e('Selector', 'extlb_link-preview') ?></th>
						<td>
							<fieldset>
								<label for="extlb_link_selector">
										...
										<?php _e('Your custom css selector', 'extlb_link-preview') ?>
								</label>
								<p class="description"><?php _e('Add your custom CSS selector here, the default is .entry-content a', 'extlb_link-preview') ?></p>
							</fieldset>
						</td>
					</tr>
				</tbody>
